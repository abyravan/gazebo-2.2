  ...
  namespace physics
  {
    ...
    class GZ_PHYSICS_ODE_VISIBLE ODEModel : public Model
    {
      ...
      public: explicit ODEModel(BasePtr _parent, dSpaceID _parentSpaceId,
                                boost::recursive_mutex *destroyMutex);
      /// \brief Destructor.
      ...
      /// \brief Mutex to make sure we are not destroying something while it's in use
      protected: boost::recursive_mutex *destroyMutex;
    };
    /// \}
  }
}

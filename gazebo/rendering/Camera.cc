...
//  // Can specify this using "anti_alias" flag in the camera block of the SDF
//  int fsaa = 4; // By default, we do anti-aliasing
//  if (this->sdf->HasElement("anti_alias"))
//  {
//    bool anti_alias = this->sdf->GetElement("anti_alias")->Get<bool>();
//    if(!anti_alias)
//        fsaa = 0; // no anti-aliasing
//  }

  int fsaa = 0; // Default: 0

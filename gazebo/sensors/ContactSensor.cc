...
{
  // Modified by Arun based on: https://bitbucket.org/osrf/gazebo/pull-requests/1413/allow-multiple-contact-sensors-per-link/diff
  ...
  // Had to make sure not to call GetEntity(parentName) here
  // as the entity has already been destroyed before you get here
  // To fix this, added a new variable - filterName which stores
  // the local filter name of the sensor
...
{
  // Added by Arun from: https://bitbucket.org/osrf/gazebo/pull-requests/1413/allow-multiple-contact-sensors-per-link/diff
